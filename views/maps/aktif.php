<?php
$this->title = 'Perangkat Aktif';
?>

<div class="site-aktif">
   <div class="col-md-12">
      <div class="box box-info">
      <center><h3 class="box-title">Letak Perangkat Aktif</h3></center>
...
<div id="mapid"></div>
	<script>
		var map = L.map('mapid').setView([-6.899541, 107.5338671], 14);
        
		<?php 
			 $query = "SELECT id,coordinates FROM data_dbd";
